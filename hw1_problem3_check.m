function results = hw1_problem3_check(varargin)
% results = hw1_problem3_check(...)
%
% Checks the variables that the student was asked to supply in
% hw1_problem3.m (every "% HERE" entry in hw1_problem3_template.m).
%
% Usage
%   1) Run the student's hw1_problem3.m so that its variables are left in
%      the workspace.
...
%
% Notes
%   * t0 and t1 are checked after the sample-alignment adjustment in 3.5,
%     since that is the value that survives to the end of the script.
%   * R, td and squint_ang are the loop variables from 3.9 and therefore
...
%
% See also HW1_PROBLEM2_CHECK, HW1_PROBLEM4_CHECK
...
if mod(numel(varargin),2) ~= 0
  error('hw1_problem3_check:badInput','Options must be name/value pairs.');
end
for arg_idx = 1:2:numel(varargin)
  if ~ismember(varargin{arg_idx}, valid_opts)
    error('hw1_problem3_check:badOption','Unknown option "%s". Valid options: %s.', ...
...
ref = { ...
  ...
  '3.5', 't0',         's', [1 1],       -7.00000000000000e-07,  0, 0, ''; ...
  '3.5', 't1',         's', [1 1],        1.01966666666667e-05,  0, 0, ''; ...
  '3.5', 'dt',         's', [1 1],        3.33333333333333e-09,  0, 0, ''; ...
  '3.5', 'time',       'a', [3270 1],     3.25735062674493e-04, -7.00000000000000e-07,  1.01966666666667e-05, ''; ...
  '3.5', 'Nt',         's', [1 1],        3270,                  0, 0, ''; ...
  '3.6', 'dx',         's', [1 1],        0.25,                  0, 0, ''; ...
  '3.6', 'x',          'a', [1 1447],     3972.39268774834,     -180.819132628538,      180.680867371462,     ''; ...
  '3.6', 'Nx',         's', [1 1],        1447,                  0, 0, ''; ...
  '3.6', 'y',          'a', [1 1447],     19019.7266016102,      500,                   500,                  ''; ...
  '3.6', 'z',          'a', [1 1447],     19019.7266016102,      500,                   500,                  ''; ...
  '3.7', 'df',         's', [1 1],        91743.1192660550,      0, 0, ''; ...
  '3.7', 'freq',       'a', [3270 1],     4952272668.90222,      0,                    -91743.1192660550,     ''; ...
  '3.7', 'range',      'a', [3270 1],     48826.4575480413,     -104.927360300121,      1528.44188170509,     ''; ...
  '3.7', 'eta',        'a', [1 1447],     31.7791415019868,     -1.44655306102830,      1.44544693897170,     ''; ...
  '3.7', 'deta',       's', [1 1],        0.002,                 0, 0, ''; ...
  '3.7', 'dkx',        's', [1 1],        0.0173688605588931,    0, 0, ''; ...
  '3.7', 'kx',         'a', [1 1447],     275.983678238558,      0,                    -0.0173688605588931,   ''; ...
  '3.7', 'df_eta',     's', [1 1],        0.345542501727713,     0, 0, ''; ...
  '3.7', 'f_eta',      'a', [1 1447],     5490.52082554370,      0,                    -0.345542501727713,    ''; ...
  '3.8', 'Kr',         's', [1 1],        6.00000000000000e+12,  0, 0, ''; ...
  '3.9', 'R',          'a', [1 1447],     27189.7021621362,      729.859958296478,      729.825716067955,     ''; ...
  '3.9', 'td',         'a', [1 1447],     1.81390168008195e-04,  4.86910153220491e-06,  4.86887309264541e-06, ''; ...
  '3.9', 'squint_ang', 'a', [1 1447],     5.54637004031261,      0.250351966713402,    -0.250168423060828,    ''; ...
  '3.9', 'data',       'a', [3270 1447],  2083.50665945660,      0,                     0,                    ''; ...
  };
...
res = run_check(ref, opt, 'hw1 problem 3', found, used, vals);
if nargout > 0
