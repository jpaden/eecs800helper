...
%     every check here.
%   * 4.2 asks for the contents of 3.3 and 3.7 to be copied in, so those
%     variables are checked again here.
...
%     used in their 4.7 and 4.8 comments. The report says when the alternate
%     name was found.
...
ref = { ...
  '4.2', 'lambda_fc',      's', [1 1],       1.53739722051459,     0, 0, ''; ...
  '4.2', 'sigma_r',        's', [1 1],       2.49827048333621,     0, 0, ''; ...
  '4.2', 'r_ref',          's', [1 1],       707.106781186547,     0, 0, ''; ...
  '4.2', 't_ref',          's', [1 1],       4.71730867349394e-06, 0, 0, ''; ...
  '4.2', 'r0',             's', [1 1],       644.606781186547,     0, 0, ''; ...
  '4.2', 'r1',             's', [1 1],       769.606781186547,     0, 0, ''; ...
  '4.2', 'L_sar',          's', [1 1],       236.638265257076,     0, 0, ''; ...
  '4.2', 'df',             's', [1 1],       91743.1192660550,     0, 0, ''; ...
  '4.2', 'freq',           'a', [3270 1],    4952272668.90222,     0,                    -91743.1192660550,   ''; ...
  '4.2', 'range',          'a', [3270 1],    48826.4575480413,    -104.927360300121,      1528.44188170509,   ''; ...
  '4.2', 'eta',            'a', [1 1447],    31.7791415019868,    -1.44655306102830,      1.44544693897170,   ''; ...
  '4.2', 'deta',           's', [1 1],       0.002,                0, 0, ''; ...
  '4.2', 'dkx',            's', [1 1],       0.0173688605588931,   0, 0, ''; ...
  '4.2', 'kx',             'a', [1 1447],    275.983678238558,     0,                    -0.0173688605588931, ''; ...
  '4.2', 'df_eta',         's', [1 1],       0.345542501727713,    0, 0, ''; ...
  '4.2', 'f_eta',          'a', [1 1447],    5490.52082554370,     0,                    -0.345542501727713,  ''; ...
  '4.3', 'ref_fft',        'a', [3270 1],    3132.09195267316, ...
                                             86.5991636882721 + 83.4266557540899i, ...
                                            -88.6541661516194 - 87.7940740280011i, ''; ...
  '4.3', 'data_pc',        'a', [3270 1447], 255026.754918221, ...
                                             0.381845008319267 + 0.151855631180688i, ...
                                             1.01751417319778 + 0.656082028412828i, ''; ...
  '4.3', 'range_pc',       'a', [3270 1],    48826.4575480413,    -104.927360300121,      1528.44188170509,   ''; ...
  '4.7', 'max_val',        'a', [1 1447],    112490.173841489, ...
                                            -2922.49466959362 - 466.673649081773i, ...
                                            -2672.67133100261 - 1252.49764956073i, ''; ...
  '4.7', 'max_idx',        'a', [1 1447],    62442.5094546976,     1672,                  1672,               ''; ...
  '4.7', 'measured_phase', 'a', [1 1447],    3180.09131734717,    -185.979770996334,     -185.699878164392,   'max_phase'; ...
  '4.7', 'expected_phase', 'a', [1 1447],    3180.09163236942,    -185.979790996315,     -185.699902019976,   ''; ...
  '4.8', 'k_fc',           's', [1 1],       8.17379558560215,     0, 0, ''; ...
  '4.8', 'kx_expected',    'a', [1 1447],    45.3348949516232,     2.04632580036882,     -2.04482555207164,   'target_kx'; ...
  };
